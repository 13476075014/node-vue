	...
	$.fn.mdater = function(config) {
		...
		var mdater = {
			...
			renderHTML: function() {
				...
				var $html = $('<div class="md_mask"></div><div class="md_panel"><div class="md_head">\
				<div class="md_selectarea"><a class="md_prev change_year" href="javascript:void(0);">&lt;\
				</a> <a class="md_headtext yeartag" href="javascript:void(0);"></a> \
				...
				</div></div><div class="md_body">\
				<ul class="md_weekarea"><li>日</li><li>一</li><li>二</li><li>三</li><li>四</li><li>五</li><li>六</li></ul>\
				<ul class="md_datearea in"></ul></div>\
				<div class="md_foot">\
				<div class="new_richeng"><p class="nrc_1"><i class="glyphicon glyphicon-circle-arrow-right"></i>2017-09-12</p><p class="nrc_2">这里是日程内容</p></div>\
				<a href="javascript:void(0);" class="md_ok">新建日程</a> \
				</div>\
				</div>');
			...
			initListeners: function() {
				...
				panel.delegates({
					...
					'.md_ok': function() {
						...
						$(".new_richeng .nrc_1").html('<i class="glyphicon glyphicon-circle-arrow-right"></i>'+_this.value.year + '-' + monthValue + '-' + dateValue);
					}
