			...
			<div class="am-g">
				<div class="am-u-lg-5 am-u-md-15 am-u-sm-centered">
					<form class="am-form m-form-horizontal"
						action="${pageContext.request.contextPath}/system/notice/addsv"
						method="post">
						<div class="am-g am-margin-top">
							...
							<div class="am-u-sm-10">
								<div class="am-form-group ">
									<div class="field">
									<input type="text" name="title" data-validate="required:标题不能为空">
									</div>
								</div>
							</div>
						...
						<div class="am-g am-margin-top">
							...
							<div class="am-u-sm-10">
								<div class="am-form-group ">
									<div class="field">
									<textarea rows="10" cols="20" class="xheditor" data-validate="required:公告内容不能为空" id="content" placeholder="公告内容" name="content"></textarea>
									</div>
								</div>
							</div>
							<div class="am-u-sm-3"></div>
