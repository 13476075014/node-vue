...
<script>
    ...
    name:'makeupGoods',
	 	data:function(){
	 		...
	 		return {
	 			talPro:[{prop:"_id",label:"id"},{prop:"perfumeCosmetics",label:"香水彩妆类型"},{prop:"bodyCare",label:"身体护理类型"},{prop:"productionPlace",label:"产地"},{prop:"brand",label:"品牌"},{prop:"facialCare",label:"面部护理"}], //要显示的表头
